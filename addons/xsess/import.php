...
/*
  ...
  Complete shorthand implementation coming soon, for now use Framework > Client > Memcache
...
class XSess {
  ...
  private function Connect($port_number=11211, $host_name='localhost') {
    if ( !$this->Memcache->connect($host_name, $port_number) )
      throw new Exception('Cannot connect to Memcache server via XSess. [xsess\main : '.__LINE__.']');
    return $this;
  }
